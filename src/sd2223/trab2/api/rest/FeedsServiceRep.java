...
public interface FeedsServiceRep {
    ...
    long postMessage(@HeaderParam(FeedsServiceRep.HEADER_VERSION) Long version, @PathParam(USER) String user, @QueryParam(PWD) String pwd, Message msg);
    ...
    @DELETE
    @Path("/{" + USER + "}/{" + MID + "}")
    void removeFromPersonalFeed(@HeaderParam(FeedsServiceRep.HEADER_VERSION) Long version,@PathParam(USER) String user, @PathParam(MID) long mid, @QueryParam(PWD) String pwd);
    ...
    @Path("/{" + USER + "}/{" + MID + "}")
    @Produces(MediaType.APPLICATION_JSON)
    Message getMessage(@HeaderParam(FeedsServiceRep.HEADER_VERSION) Long version,@PathParam(USER) String user, @PathParam(MID) long mid);
    ...
    @Path("/{" + USER +"}")
    @Produces(MediaType.APPLICATION_JSON)
    List<Message> getMessages(@HeaderParam(FeedsServiceRep.HEADER_VERSION) Long version,@PathParam(USER) String user, @QueryParam(TIME) long time);
    ...
    void subUser(@HeaderParam(FeedsServiceRep.HEADER_VERSION) Long version,@PathParam(USER) String user, @PathParam(USERSUB) String userSub, @QueryParam(PWD) String pwd);
    ...
    @DELETE
    @Path("/sub/{" + USER + "}/{" + USERSUB + "}")
    void unsubscribeUser(@HeaderParam(FeedsServiceRep.HEADER_VERSION) Long version,@PathParam(USER) String user, @PathParam(USERSUB) String userSub, @QueryParam(PWD) String pwd);
    ...
    @Path("/sub/list/{" + USER + "}")
    @Produces(MediaType.APPLICATION_JSON)
    List<String> listSubs(@HeaderParam(FeedsServiceRep.HEADER_VERSION) Long version,@PathParam(USER) String user);
